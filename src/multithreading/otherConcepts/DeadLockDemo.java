package multithreading.otherConcepts;
...
public class DeadLockDemo {
    ...
    public static void main(String[] args) {
        ...
        // Approach to find DeadLocks
        // Try to understand if there are any threads in deadlock
        new Thread(() -> {
            ThreadMXBean mxBean = ManagementFactory.getThreadMXBean();
            while (true) {
                long[] threadIds = mxBean.findDeadlockedThreads();   // more information about deadlock
                if (threadIds != null) {
